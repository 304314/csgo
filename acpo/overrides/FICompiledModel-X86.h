...
//   (arg0: f32[1,100]) -> (f32[1,2])
//
// Memory stats:
//   arg bytes total:    400
//   arg bytes aligned:  448
//   temp bytes total:   5136
//   temp bytes aligned: 5248
...
::xla::cpu_function_runtime::BufferInfo({4194304ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({4194304ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({262144ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({262144ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({102400ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({16384ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({4096ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({4096ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({2048ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({1602ULL, 0ULL}),
...
::xla::cpu_function_runtime::BufferInfo({20481ULL, ~0ULL})
      };
    return kBufferInfos;
  }
