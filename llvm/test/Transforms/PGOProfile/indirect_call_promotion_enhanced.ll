; RUN: opt < %s -passes=pgo-icall-prom -profile-summary-cutoff-hot-icp=200000 profile-summary-hot-count-for-ipc -pass-remarks=pgo-icall-prom 2>&1 | FileCheck %s --check-prefix=PASS-REMARK
; RUN: opt < %s -passes=pgo-icall-prom -profile-summary-cutoff-hot-icp=100000 profile-summary-hot-count-for-ipc -pass-remarks=pgo-icall-prom 2>&1 | FileCheck %s --check-prefix=FAIL-REMARK
